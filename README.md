...
## Εγκατάσταση εφαρμογής
Προκειμένου να εκτέλεσετε την εφαρμογή κατεβάστε τον κώδικα από το παρακάτω link καθώς και το [αρχείο δεδομένων]() θα πρέπει να έχετε στον υπολογιστή σας ένα compiler της C++ προκειμένου να εκτελέσετε την εφαρμογή, εναλλακτικά μπορείτε να κατεβάσετε το [main.exe](https://github.com/DrG2020/00078_aadd_ett/blob/main/main.exe) 
